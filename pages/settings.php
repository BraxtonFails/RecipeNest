...
<head>
  ...
  <title>Settings – RecipeNest</title>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          ...
          <div class="d-flex align-items-center gap-3 mb-4">
            <a href="profile.php" class="btn btn-rn-outline btn-sm"><i class="bi bi-arrow-left me-1"></i>Back to profile</a>
            <h1 class="h4 mb-0 fw-bold">Account Settings</h1>
          </div>
